...
const pilotEnabled = new Set(['/visitantes','/celulas','/relatorios-celula']);
const links = [
  { to:'/quadro-avisos',label:'Quadro de avisos',icon:ClipboardList},{to:'/dashboard',label:'Dashboard',icon:Home},
  {to:'/membros',label:'Membros',icon:Users},{to:'/visitantes',label:'Visitantes',icon:UserRoundPlus},
  {to:'/celulas',label:'Células',icon:Workflow},{to:'/relatorios-celula',label:'Relatório da célula',icon:ClipboardCheck},
  {to:'/solicitacoes',label:'Solicitações',icon:FileClock},{to:'/financeiro',label:'Financeiro',icon:DollarSign},
  {to:'/eventos',label:'Eventos',icon:CalendarDays},{to:'/relatorios',label:'Relatórios',icon:Bell},
  {to:'/avisos',label:'Gerenciar avisos',icon:Megaphone},{to:'/radio',label:'Rádio',icon:Radio},{to:'/configuracoes',label:'Configurações',icon:Settings}
];
